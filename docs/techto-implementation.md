...
This document describes the implementation that exists in the repository. For
system invariants, provider rules, model training, and open research questions,
